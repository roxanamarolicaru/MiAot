...
class MyMQTT:
    ...
    def __init__(self, clientID, broker, port, notifier):
        ...
        self.paho_mqtt.on_message = self.myOnMessageReceived
    ...
    def myPublish (self, topic, msg):
        ...
        self.paho_mqtt.publish(topic, json.dumps(msg), 2)
    ...
    def start(self):
       ...
       # self.paho_mqtt.connect_async(self.broker , self.port)
        print('connected')
    ...
    def unsubscribe(self):
        ...
        if (self._isSubscriber):
            ...
            self.paho_mqtt.unsubscribe(self._topic)
